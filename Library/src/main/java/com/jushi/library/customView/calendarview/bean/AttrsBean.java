...
public class AttrsBean {
    ...
    private boolean manualRolling; //是否允许手动滑动
    ...
    public boolean isManualRolling() {
        return manualRolling;
    }

    public void setManualRolling(boolean manualRolling) {
        this.manualRolling = manualRolling;
    }
}
