...
/**
 * SHA1签名检测
 * create by wyf on 2020/1/17
 */
public class SHA1SignCheck {

    private Context context;
    private String cer = null;
    private String realCer = null;
    private static final String TAG = "SHA1SignCheck";

    public SHA1SignCheck(Context context) {
        this.context = context;
        this.cer = getCertificateSHA1Fingerprint();
    }

    public SHA1SignCheck(Context context, String SHA1) {
        this.context = context;
        this.realCer = SHA1;
        this.cer = getCertificateSHA1Fingerprint();
    }
     ...
     * @param SHA1
     */
    public void setRealCer(String SHA1) {
        this.realCer = SHA1;
    }
